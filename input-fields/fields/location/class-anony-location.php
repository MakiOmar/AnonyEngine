...
class ANONY_Location {
	...
	public function render() {
		...
		$html .= '<a href="#" onclick="event.preventDefault();" class="fetch-location-button" data-target="' . $this->parent_obj->field['id'] . '">' . apply_filters( 'anony_location_icon', $icon ) . '</a></div>';
