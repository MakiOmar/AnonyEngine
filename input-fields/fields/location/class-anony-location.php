...
class ANONY_Location {
	...
	public function render() {
		...
		$html .= '<a href="#" onclick="event.preventDefault();" class="fetch-location-button" data-target="' . $this->parent_obj->field['id'] . '"><?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
		...
		$html .= '<span id="' . $this->parent_obj->field['id'] . '-response"></span>';
