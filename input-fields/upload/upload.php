    ...
    function enqueue() {
        ...
        if ( $wp_version < "3.5" ) {
            wp_enqueue_script(
                ...
                ANONY_INPUT_FIELDS_URI . 'upload/field_upload_3_4.js', 
            ...
            wp_enqueue_script(
                'anony-opts-field-upload-js', 
                ANONY_INPUT_FIELDS_URI . 'upload/field_upload.js', 
                array('jquery'),
                time(),
                true
            );
        ...
        wp_localize_script('anony-opts-field-upload-js', 'anony_upload', array('url' => ANONY_INPUT_FIELDS_URI.'upload/blank.png'));
    }
}
