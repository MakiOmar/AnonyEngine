	    ...
	    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
	    	...
	    	<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
		          ...
		          <td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
		            ...
		            <h1><a href="#"><?= $anony_share_title ?></a></h1>
		          </td>
			    </tr>
				
				<!-- Header -->
				<tr>
		          <td valign="middle" class="hero" style="background-image: url('<?= $anony_share_img ?>'); background-size: cover; height: 400px;">
		            <table style="margin:auto">
		            	<tr>
		            		<td>
		            			<div class="text" style="padding: 0 3em; text-align: center; margin-top: 180px">
		            				<h2>We Care about your choices</h2>
		                            <p>Carefully selected properties to be the best representive about what we can do<p>
		            				<p><a href="#" class="btn btn-primary">For more, click here</a></p>
		            			</div>
		            		</td>
		            	</tr>
		            </table>
